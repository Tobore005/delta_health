                    ...
                    <div className="grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-8">
                        ...
                        <div className="mx-auto w-full max-w-xl space-y-6 text-center lg:mx-0 lg:text-left">
                            ...
                            <h1 className="text-3xl leading-tight font-bold text-black sm:text-4xl lg:text-5xl">
                                Welcome Back, <span className="text-violet-700">Admin</span>
                            </h1>
                            <p className="mx-auto max-w-md text-gray-600 lg:mx-0">
                                Log in to manage appointments, patients, and more for your admin.
                            </p>
                        ...
                        <div className="mx-auto w-full max-w-md rounded-2xl bg-white p-8 shadow-lg">
                            <h2 className="mb-2 text-center text-2xl font-bold text-violet-700">Admin Login</h2>
                            <p className="mb-6 text-center text-gray-500">Enter your admin email and password below to log in</p>
